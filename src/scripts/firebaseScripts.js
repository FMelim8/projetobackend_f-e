...
export async function addPost(post, username, email) {
    try {
        const response = await axios.post(`/api/posts/${username}`, {
...
export async function editPost(postId, username, comment, url) {
    try {
        const response = await axios.put(`/api/posts/${username}/${postId}`, {
            comment,
            url
        });
        console.log('Post edited successfully');
...
export async function deletePost(postId, username) {
    try {
        const response = await axios.delete(`/api/posts/${username}/${postId}`);
        console.log('Post deleted successfully');
        return response.data;
    } catch (error) {
        console.error('Error deleting post: ', error);
...
export async function getPostsFollowing(username) {
    try {
        const response = await axios.get(`/api/posts/following/${username}`);
        return response.data;
    } catch (error) {
        console.error('Error getting posts of followed users: ', error);
        throw error;
    }
}
...
export async function likePost(posterUsername, likerUsername, postId) {
    try {
        const response = await axios.post(`/api/posts/${posterUsername}/${postId}/like`, {
            likerUsername
        });
        console.log('Post liked successfully');
        return response.data;
...
export async function unlikePost(posterUsername, likerUsername, postId) {
    try {
        const response = await axios.post(`/api/posts/${posterUsername}/${postId}/unlike`, {
            likerUsername
        });
        console.log('Post unliked successfully');
        return response.data;
...
export async function userLikedPost(posterUserName, likerUserName, postId) {
    try {
        const response = await axios.get(`/api/posts/${posterUserName}/${postId}/liked/${likerUserName}`);
        return response.data;
    } catch (error) {
...
export async function followUser(currentUser, userToFollow) {
    try {
        const response = await axios.post(`/api/users/${currentUser}/follow/${userToFollow}`);
        console.log('User followed successfully');
        return response.data;
    } catch (error) {
        console.error('Error following user: ', error);
...
export async function unfollowUser(currentUser, userToUnfollow) {
    try {
        const response = await axios.post(`/api/users/${currentUser}/unfollow/${userToUnfollow}`);
        console.log('User unfollowed successfully');
        return response.data;
    } catch (error) {
        console.error('Error unfollowing user: ', error);
...
export async function isUserFollowing(currentUsername, targetUsername) {
    try {
        const response = await axios.get(`/api/users/${currentUsername}/following/${targetUsername}`);
        return response.data;
    } catch (error) {
...
export async function getProfilePicture(userName) {
    try {
        const response = await axios.get(`/api/users/${userName}/profile-picture`);
        profilePictureUser.value = response.data.pictureProfile;
...
export async function userExists(username) {
    try {
        const response = await axios.get(`/api/users/${username}/exists`);
